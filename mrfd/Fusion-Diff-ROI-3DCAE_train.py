...
parser.add_argument('--lambda_T_S', default='0.1',
                    help='MSE loss hyperparameter for thermal frames')
parser.add_argument('--lambda_T_T', default='0.1',
                    help='MSE loss hyperparameter for thermal difference frames')
...
lambdas=[float(args.lambda_T_S),float(args.lambda_T_T),float(args.lambda_F)]
...
GAN3D.train(thermal_frame=ADL_ROI_frame_windows, thermal_mask=ADL_mask_windows,thermal_diff_masks=ADL_diff_mask_windows,flow_frame=ADL_ROI_flow_windows, flow_mask=ADL_flow_mask_windows,epochs= epochs,epochs_trained=epochs_trained, save_interval = 10)
