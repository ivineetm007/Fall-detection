Enter the dataset path, object detector model from tensorfow zoo library in config.py

python Person tracking --help
python Person tracking --output_type video
---------------
Previous SOTA model
---------------
ConvLSTMAE
